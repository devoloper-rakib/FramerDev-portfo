    ...
    <section className="w-full pt-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="I am very flexible with time zone communications and I always try to improve. I try to be as open as possible with client collaboration"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="I use NextJs to build and deploy. I use GraphQL for API calls and MongoDB for database. I also use Typescript to write the code. "
        >
          <CanvasRevealEffect
            animationSpeed={3}
